...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;y_q(t) = \frac{B_q}{D_q} + \sum_{r=1}^R S_{rq} \exp(-D_q t) \int_0^t f_r(\tau ) \exp (D_q \tau ) d \tau" title="\Large x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}" />
